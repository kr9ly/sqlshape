...
First vertical slice works: the analyzer agrees with the PostgreSQL oracle on 83 golden
statements (contrib extensions included) and the checker reports type / column / nullability

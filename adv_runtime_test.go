...
func TestAdvRuntime_A1_NullableStructFieldMissingColumn(t *testing.T) {
	...
	if rows, err := stmt.Collect(ctx, db, struct{}{}); err != nil {
	...
	if rows, err := stmt2.Collect(ctx, db, struct{}{}); err != nil {
...
func TestAdvRuntime_A2_StaleOIDFormatCacheAfterTypeRecreated(t *testing.T) {
	...
	rows, err := getAmt.Collect(ctx, db, struct{}{})
	...
	rows2, err := getAmt.Collect(ctx, db, struct{}{})
	if err != nil {
